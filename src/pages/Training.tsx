      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            <Link to="/training/certifications" className="card-professional group p-8">
            ...
            <Link to="/training/bootcamps" className="card-professional group p-8">
              <Code2 className="w-10 h-10 text-primary mb-4" />
              <h2 className="text-2xl font-bold text-foreground mb-3">Bootcamps</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
