    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="text-2xl sm:text-4xl font-bold mb-2 text-foreground">Privacy Policy</h1>
          <p className="text-sm text-muted-foreground mb-10">Last updated: {LAST_UPDATED}</p>

          <div className="space-y-8 text-foreground/90 leading-relaxed">
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">What we collect</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">How we use it</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">Analytics</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">Data retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">Your rights</h2>
              <p>
